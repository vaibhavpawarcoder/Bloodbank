                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card" style="min-height: 490px">
                            <div class="row justify-content-evenly">
                                <h1 class="text-center mt-5 mb-2 text-danger ">Send Request To Donar</h1>
                                <p class="text-center m-3 text-danger h6">Find Near By Donar(search in City, District, Staet)</p>
                                <div class="col-md-9">
                                    <form class="row gy-2 gx-3 align-items-center" method="post">
                                        ...
                                        <div class="row text-center justify-content-evenly mt-5">
                                            <div class="col-md-3">
                                                <button type="submit" name="submit" class="btn btn-danger">Search Donar</button>
                                            ...
                                            <div class="col-md-12 mt-3 mb-3">
                                                <div class="row justify-content-around text-center">
                                                    ...
                                                    <div class="col-md-5 float-start">
                                                        ...
                                                        <br>
                                                        <a   class="btn bg-primary text-white">Send Request</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
