            ...
            <div class="main-content">
                ...
                <div class="row ">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <h3 class="text-center m-3">Donar Registration Information</h3>
                            ...
                            if (isset($_POST['search'])) {
                                $info = $_POST['info'];
                                $infosearch = "select * from donar_registration where Bloodgroup like '%$info%' or First_Name like '%$info%'  or Last_name like '%$info%' or City like '%$info%'  or State like '%$info%' or District like '%$info%'
                                LIMIT 10 ";
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $select = "select * from donar_registration LIMIT 10  ";
